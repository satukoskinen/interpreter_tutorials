...
# Token types
(PROGRAM, VAR, INTEGER, REAL, INTEGER_CONST, REAL_CONST, LPAREN, RPAREN, PLUS, MINUS, MUL, FLOAT_DIV, INTEGER_DIV, ID, ASSIGN, BEGIN, END, SEMI, COLON, COMMA, DOT, EOF) = (
    "PROGRAM", "VAR", "INTEGER", "REAL", "INTEGER_CONST", "REAL_CONST", "(", ")", "PLUS", "MINUS", "MUL", "FLOAT_DIV", "INTEGER_DIV", "ID", "ASSIGN", "BEGIN", "END", "SEMI", "COLON", "COMMA", "DOT", "EOF"
    )
    ...
    def get_next_token(self):
        ...
        while self.current_char is not None:
            if self.current_char.isspace():
                ...
                print("error char", self.current_char)
                self.error()
...
class Parser(object):
    ...
    def eat(self, token_type):
        print("eat ", token_type, self.current_token.type)
...
class SymbolTableBuilder(NodeVisitor):
    ...
    def visit_Assign(self, node):
        var_name = node.left.value
        var_symbol = self.symbtab.lookup(var_name)
